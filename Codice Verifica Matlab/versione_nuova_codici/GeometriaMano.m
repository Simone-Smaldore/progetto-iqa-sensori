...
plot(XprimoPollice,YprimoPollice,'.g','MarkerSize', 16)
plot(XmassimoPollice ,YmassimoPollice,'.r','MarkerSize', 16)
plot(XMedioMignolo ,YMedioMignolo,'.y','MarkerSize', 16)
plot(XMedioAnulare ,YMedioAnulare,'.y','MarkerSize', 16)
plot(XMedioIndice ,YMedioIndice,'.y','MarkerSize', 16)
plot(XMedioPollice ,YMedioPollice,'.y','MarkerSize', 16)
 plot(XmassimoMedio ,YmassimoMedio,'.y','MarkerSize', 16)
...
plot(A3,A4, 'm','LineWidth', 2); 
plot(A5,A6, 'm','LineWidth', 2); 
plot(A7,A8, 'm','LineWidth', 2); 
plot(A9,A10, 'm','LineWidth', 2); 
plot(A11,A12, 'm','LineWidth', 2); 
plot(A13,A14, 'm','LineWidth', 2); 
plot(A15,A16, 'm','LineWidth', 2);  
plot(A17,A18, 'm','LineWidth', 2);  
plot(A19,A20, 'm','LineWidth', 2); 
plot(A21,A22, 'm','LineWidth', 2); 
plot(A23,A24, 'm','LineWidth', 2); 
plot(A25,A26, 'm','LineWidth', 2);  
plot(A27,A28, 'm','LineWidth', 2);  
plot(A29,A30, 'm','LineWidth', 2); 
plot(A31,A32, 'm','LineWidth', 2);  
plot(A33,A34, 'm','LineWidth', 2); 
plot(A35,A36, 'm','LineWidth', 2); 
plot(A37,A38, 'm','LineWidth', 2); 
plot(A39,A40, 'm','LineWidth', 2); 
plot(A41,A42, 'c','LineWidth', 2); 
%%%Adriano
plot(A43,A44, 'y','LineWidth', 2); 
plot(A45,A46, 'y','LineWidth', 2); 
plot(A47,A48, 'y','LineWidth', 2); 
set(gcf,'Color','w')
...
plot(p2,p1,'w','LineWidth', 2); 
plot(A91,A101, 'w','LineWidth', 2);
set(gcf,'Color','w')
...
%              
  ...
  %plot(A43,A44,'m--','LineWidth', 2); 
% 
  A45 = [XsecondoPuntoRoiPalmo XquartoPuntoRoiPalmo];
  A46 = [YsecondoPuntoRoiPalmo YquartoPuntoRoiPalmo];
  %plot(A45,A46,'m','LineWidth', 2);
% 
  A47 = [XprimoPuntoRoiPalmo XterzoPuntoRoiPalmo];
  A48 = [YprimoPuntoRoiPalmo YterzoPuntoRoiPalmo];
 %plot(A47,A48,'m','LineWidth', 2);
% 
  A49 = [XterzoPuntoRoiPalmo XquartoPuntoRoiPalmo];
  A50 = [YterzoPuntoRoiPalmo YquartoPuntoRoiPalmo];
 %plot(A49,A50,'m', 'LineWidth', 2);
plot(XsecondoAnulare ,YsecondoAnulare,'.c','MarkerSize', 16)
plot(XprimoAnulare ,YprimoAnulare,'.c','MarkerSize', 16)
plot(XmassimoAnulare ,YmassimoAnulare,'.m','MarkerSize', 16)
plot(XsecondoMignolo ,YsecondoMignolo,'.w','MarkerSize', 16)
plot(XprimoMignolo ,YprimoMignolo,'.c','MarkerSize', 16)
plot(XmassimoMignolo ,YmassimoMignolo,'.m','MarkerSize', 16)
plot(XprimoMedio ,YprimoMedio,'.c','MarkerSize', 16)
plot(XmassimoMedio ,YmassimoMedio,'.m','MarkerSize', 16)
plot(XsecondoIndice ,YsecondoIndice,'.c','MarkerSize', 16)
plot(XprimoIndice,YprimoIndice,'.w','MarkerSize', 16)
plot(XmassimoIndice ,YmassimoIndice,'.m','MarkerSize', 16)
plot(XsecondoPollice ,YsecondoPollice,'.c','MarkerSize', 16)
plot(XprimoPollice,YprimoPollice,'.w','MarkerSize', 16)
plot(XmassimoPollice ,YmassimoPollice,'.m','MarkerSize', 16)
plot(XMedioMignolo ,YMedioMignolo,'.y','MarkerSize', 16)
plot(XMedioAnulare ,YMedioAnulare,'.y','MarkerSize', 16)
plot(XMedioIndice ,YMedioIndice,'.y','MarkerSize', 16)
plot(XMedioPollice ,YMedioPollice,'.y','MarkerSize', 16)
plot(XpuntoMedio ,YpuntoMedio,'.y','MarkerSize', 16)
plot(XmassimoMedio ,YmassimoMedio,'.m','MarkerSize', 16)
 plot(XsecondoDistanze ,YsecondoDistanze,'.r','MarkerSize', 16)
plot(partenza(2) ,partenza(1),'.b','MarkerSize', 16)
