...
mkdir('Template3D');
mkdir(['Template3D' slash 'dat']);
mkdir(['Template3D' slash 'jpg']);
...
% mkdir(['Template3D' slash 'istante010']);
% mkdir(['Template3D' slash 'istante011']);
% mkdir(['Template3D' slash 'istante012']);
% mkdir(['Template3D' slash 'istante013']);
