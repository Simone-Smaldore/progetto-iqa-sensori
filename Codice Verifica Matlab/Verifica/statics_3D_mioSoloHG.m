% - Calcolo di genuini
% - Costruzione tabella impostori e genuini
% - Grafici di ML: imp/gen, far/frr
% - Calcolo di EER, salvataggio
% - Det Curve
% - Metodologia fused, calcolo score
% - Grafici della fused: imp/gen, far/frr
% - Calcolo di EER, salvataggio
% - Grafici di DET e ROC per più metodologie
...
%APPROSSIMAZIONE
%CALCOLO ANDAMENTO DI IMPOSTORI E GENUINI, FAR ED FRR, ROC E DET PER LA
%SINGOLA METODOLOGIA ML
 load 3D_Global_Features.mat;
...
set(plot1(1),'DisplayName','impostor', 'Linewidth', 1.5);
xlabel('Score','FontSize',32, 'FontName', 'TimesNewRoman');
ylabel('Frequency','FontSize',32, 'FontName', 'TimesNewRoman');
hold on;
plot2=plot(approssimazione:approssimazione:1,vett_norm_genuino,'Color','red');
set(plot2(1),'Color',[1 0 0],'DisplayName','genuine', 'Linewidth', 1.5);
...
set(plot1(1),'DisplayName','FAR','Linewidth', 1.5);
xlabel('Threshold t','FontSize',32, 'FontName', 'TimesNewRoman');
ylabel('Error probability','FontSize',32, 'FontName', 'TimesNewRoman');
hold on;
plot2=plot(0:0.001:1,frr_interp,'Color','red','Linewidth', 1.5);
